...
- **Recovery (без Telegram):** http://81.200.146.32:5001/recovery — ввод Telegram ID → актуальная ссылка `tg://proxy` (дублирует `/proxy`) + перезапуск контейнера прокси; см. `docs/telegram-mtproxy-operators-guide.md`
