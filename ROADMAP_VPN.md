...
- [ ] **Telegram‑proxy (MTProto)**
  - [ ] Выбрать и установить MTProto‑сервер на Fornex или отдельном VPS.
  - [ ] Настроить юнит systemd и мониторинг для MTProto.
  - [ ] Сформировать и задокументировать ссылку подключения `tg://proxy?...` для друзей.
  - [ ] Описать сценарии: «Telegram только через прокси» vs «Telegram через VPN».
