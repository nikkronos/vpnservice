...
- [ ] **Обход блокировок РКН (eu1 и устойчивость)** — приоритет: высокий
  ...
  - [ ] **Доработать бота:** обновить инструкции в Telegram-боте — выдавать инструкцию по AmneziaWG (ПК + iOS через «Поделиться»), при возможности — выдавать конфиг/ссылку Amnezia.
