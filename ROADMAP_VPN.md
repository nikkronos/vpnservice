...
- [x] **Веб-панель мониторинга** — 2026-02-20
  - [x] Создана базовая структура веб-панели (`web/`)
  - [x] Реализовано Flask-приложение с API для мониторинга
  - [x] Созданы HTML шаблоны и CSS стили
  - [x] Добавлена функциональность: статус серверов, статистика пользователей, количество подключений
  - [ ] **Следующий этап**: Деплой веб-панели на сервере, настройка systemd сервиса
