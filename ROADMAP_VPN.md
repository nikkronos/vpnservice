...
- [x] **Инструкции по платформам** — выполнено ранее
  - [x] `/instruction` разбита на секции: iOS, Android, Windows с inline-кнопками
  - [x] Mac не покрываем (нет устройства для тестирования)
