...
- [ ] **Анализ конкурентов (UX-фокус)**
  - [ ] Пройтись по боту каждого конкурента как пользователь: онбординг, UX, фичи
  - [ ] Цель: найти лучшие практики и то, чего нет у нас
  - [ ] Конкуренты для разбора: @hitvpnbot, @barinvpn_bot, @Vpn_Save_Bot, @space_connect_bot, @flexiblevpn_bot
  - [ ] Зафиксировать в `docs/competitors-analysis.md`
