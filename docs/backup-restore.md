...
Перед любыми изменениями на сервере Fornex создавать резервные копии конфигов WireGuard, Shadowsocks и (при необходимости) MTProto. При сбое — восстанавливать из бэкапа.
