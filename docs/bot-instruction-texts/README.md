...
3. При выборе платформы (ПК / iPhone–iPad) отправлять соответствующий текст; при необходимости отправлять оба варианта.

## Обновление

При изменении шагов в `docs/client-instructions-pc.md` или `docs/client-instructions-ios.md` обновить соответствующий `instruction_*_short.txt` и задеплоить бота.
